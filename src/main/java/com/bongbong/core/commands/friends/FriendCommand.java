package com.bongbong.core.commands.friends;
...
public class FriendCommand extends BaseCommand {
    ...
    public FriendCommand(CorePlugin plugin, String name) {
            ...
            switch(args[0].toLowerCase()) {
                ...
                case "add":
                    ...
                    if (to != null) {
                        ...
                        Profile toProfile = plugin.getProfileManager().get(to.getUniqueId());
                ...
                case "remove":
                    ...
                    for (String key : profile.getFriends().keySet()) {
                        ...
                        if (args[1].equals(name)) {
                            toProfile = plugin.getProfileManager().get(UUID.fromString(key));
                        }
                    }
